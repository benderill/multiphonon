...
def twinx_rad(data):
    ...
    ax1.semilogy(egrid.ET, ocp.kn_r[5,:], label=r'$nkn$', color="#1f77b4", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.kp_r[5,:], label=r'$pkp$', color="#ff7f0e", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.eta_R_r[5,:], label=r'$\eta_{Rr}$',color="#296E01", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.en_r[5,:], label=r'$en$',color="#1f77b4", linestyle='--')
    ax1.semilogy(egrid.ET, ocp.ep_r[5,:], label='$ep$',color="#ff7f0e", linestyle='--')
    ...
    ax2 = ax1.twinx()
    plt.plot(egrid.ET, ocp.f_T_r[5,:],label=r"$f_{T}$", color="#000000", linestyle='-')
    plt.plot(egrid.ET, 0.5 * numpy.ones(len(egrid.ET)) ,color="#000000", linestyle=':')
...
def twinx_mp(data):
    ...
    ax1.semilogy(egrid.ET, ocp.kn_m[5,:], label=r'$nkn$', color="#1f77b4", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.kp_m[5,:], label=r'$pkp$', color="#ff7f0e", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.eta_R_m[5,:], label=r'$\eta_{R}$',color="#296E01", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.en_m[5,:], label=r'$en$',color="#1f77b4", linestyle='--')
    ax1.semilogy(egrid.ET, ocp.ep_m[5,:], label='$ep$',color="#ff7f0e", linestyle='--')
    ...
    ax2 = ax1.twinx()
    plt.plot(egrid.ET, ocp.f_T_m[5,:],label=r"$f_{T}$", color="#000000", linestyle='-')
    plt.plot(egrid.ET, 0.5 * numpy.ones(len(egrid.ET)) ,color="#000000", linestyle=':')
    ax2.set_xlabel(r'Defect energy level $E_T$ [eV]')
...
def twinx_combined(data):
    ...
    ax1.semilogy(egrid.ET, ocp.eta_R[5,:], label=r'$\eta_R$',color="#296E01", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.eta_R_s[5,:], label=r'$\eta_{Rc}$',color="#8B0000", linestyle='-')
...
def twinx_constant(data):
    ...
    ax1.semilogy(egrid.ET, ocp.kn_s[10,:], label=r'$nkn$', color="#1f77b4", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.kp_s[10,:], label=r'$nkp$', color="#ff7f0e", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.eta_R_s[10,:], label=r'$\eta_{R}$',color="#296E01", linestyle='-')
    ax1.semilogy(egrid.ET, ocp.en_s[10,:], label=r'$en$',color="#1f77b4", linestyle='--')
    ax1.semilogy(egrid.ET, ocp.ep_s[10,:], label='$ep$',color="#ff7f0e", linestyle='--')
    ax1.set_xlabel(r'Defect energy level $E_T$ [eV]')
    ax1.set_ylabel(r"Rate $[1/s]$")
    ...
    ax2 = ax1.twinx()
    plt.plot(egrid.ET, ocp.f_T_s[10,:],label=r"$f_{T}$", color="#000000", linestyle='-')
    plt.plot(egrid.ET, 0.5 * numpy.ones(len(egrid.ET)) ,color="#000000", linestyle=':')
    ax2.set_xlabel(r'Defect energy level $E_T$ [eV]')
